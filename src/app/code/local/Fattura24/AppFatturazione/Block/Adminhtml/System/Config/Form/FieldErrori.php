...
class Fattura24_AppFatturazione_Block_Adminhtml_System_Config_Form_FieldErrori
...
{    
    ...
    function getApiKeyCheckMessage()
    {
        ...
        else if(!empty($apiKey) && $apiKeyCheck['returnCode'] !== 1)
    ...
    function getVersionCheckMessage()
    {
        ...
        {
            $versionCheckMessage .= $this->getErrorHtml('Attenzione: questo modulo non è compatibile con la corrente versione di Magento. 
        ...
        else
        {
            ...
            if($checkNewVersion)
            {
                ...
                if($latest_version_date != Mage::helper('appfatturazione')->getModuleDate())
                {
                    ...
                    $versionCheckMessage .= $this->getNoticeHtml('È stata rilasciata una nuova versione del modulo! Clicca <a href="' . $urlDownload . 
